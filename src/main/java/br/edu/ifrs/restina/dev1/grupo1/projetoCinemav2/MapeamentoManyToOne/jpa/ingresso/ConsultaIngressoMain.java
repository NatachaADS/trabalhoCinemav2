...
public class ConsultaIngressoMain {
    ...
    public static void main(String[] args) {
        ...
        List<Ingresso> todosIngressos = ingressoRepository.listar();

        for (Ingresso ingresso : todosIngressos) {
            System.out.printf("%s - %s - %s\n", ingresso.getDataIngresso(), ingresso.getHorarioIngresso(),
                    ingresso.getVendaIngresso().getHorarioVendaIngresso());
        }
    }
}
